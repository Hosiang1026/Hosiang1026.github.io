...
前言 说到 Android 启动优化，你一般会想到什么呢？ Android 多线程异步加载 Android 首页懒加载 对，这是两种很常见的优化手段，但是如果让你主导这件事情，你会如何开始呢？ 梳理现有的业务...
<!-- more -->
 ...
 这篇文章,加上一些 Demo，足足花了我几个晚上的时间，觉得不错的话可以  
