...
#### 1.1 JVM是如何在保证可移植性的前提下提供高执行效率的
![Test](https://oscimg.oschina.net/oscnet/up-c848b6a082d833145c3095b03a263c2d0ff.png  'JVM深入研究挖掘课题') 
...
### 五、Java反射调用
 ...
 之所以 JDK 不从开始便采用动态生成字节码的方式，主要是因为生成过程需要耗费一定的时间。对于那些整个生命周期中仅执行数次的反射调用，动态生成字节码将得不偿失。 
