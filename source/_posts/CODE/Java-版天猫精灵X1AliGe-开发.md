...
阿里巴巴人工智能实验室在2018云栖大会上发布了AliGenie人工智能系统，这是面向软硬件厂商和开发者的开放式平台，将ASR语音识别、NLP自然语言处理、TTS语音合成等核心技术能力对外共享。本文详细介绍如何使用Java开发天猫精灵X1的自定义技能，从AliGenie开发者平台注册、技能创建、意图配置到后端服务开发，完整讲解智能语音助手的开发流程，帮助开发者快速上手AliGenie平台，打造属于自己的智能语音应用。
