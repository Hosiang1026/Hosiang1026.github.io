...
![IntelliJ IDEA](https://hosiang1026.github.io/photos/image/2024/12/15/10s8do5.png "IntelliJ IntelliJ IDEA部署项目至远程Tomcat-入门篇")
...
![IDEA](https://hosiang1026.github.io/photos/image/2024/12/15/10s8qz3.png "IDEA部署项目至远程Tomcat-入门篇")
...
![IDEA](https://api.opics.org/api "IDEA部署项目至远程Tomcat-入门篇")
...
![IDEA](https://hosiang1026.github.io/photos/image/2024/12/15/10r8a0h.png "IDEA部署项目至远程Tomcat-入门篇")
...
![IDEA](https://hosiang1026.github.io/photos/image/2024/12/15/10rkvys.png "IDEA部署项目至远程Tomcat-入门篇")

![IDEA](https://hosiang1026.github.io/photos/image/2024/12/15/10rlp1n.png "IDEA部署项目至远程Tomcat-入门篇")

### 三、远程Tomcat配置

1、 使用IntelliJ IDEA，打开菜单Run -> 选择Edit Configuration 

![IDEA](https://hosiang1026.github.io/photos/image/2024/12/15/10spl2p.png "步骤一")

2、 点击“+”号 -> 选择“Tomcat Server” -> 选择“Remote”

![IDEA](https://hosiang1026.github.io/photos/image/2024/12/15/10rjqbv.png "IDEA部署项目至远程Tomcat-入门篇")

![IDEA](https://hosiang1026.github.io/photos/image/2024/12/15/10rj71o.png "IDEA部署项目至远程Tomcat-入门篇")

3、启动Tomcat

   部署自己的项目（springmvc），启动远程Tomcat.

![IDEA](https://hosiang1026.github.io/photos/image/2024/12/15/10spt09.png "IDEA部署项目至远程Tomcat-入门篇")


### 四、访问页面

![IntelliJ IDEA](https://api.opics.org/api "IntelliJ IntelliJ IDEA部署项目至远程Tomcat-入门篇")
