...
```javascript 一、通过instanceof判断：返回一个布尔值 let a = []; a instanceof Array; //true let b = {}; b instanceof Array; //false instanceof运算符检测Array.prototyp...
...
配合 `Object.prototype.toString().call()` 进行封装 
