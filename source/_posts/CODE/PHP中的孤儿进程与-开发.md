...
修改第三个案例的代码，但是，我们并不添加WNOHANG，演示说明pcntl_waitpid()功能： 
  ...
  `下面是运行结果，一个执行php zombie3.php 程序的终端窗口```java
...
```
以上内容希望帮助到大家，更多PHP大厂PDF面试文档，PHP进阶架构视频资料，PHP精彩好文免费获取可以2021金三银四大厂面试真题集锦，必看！ 
