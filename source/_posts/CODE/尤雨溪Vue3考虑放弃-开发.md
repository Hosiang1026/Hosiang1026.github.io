...
---
 ...
 知乎官宣 凌晨时分，尤雨溪突然在知乎上发布了一个消息，宣布 Vue3 将不再支持 IE11，来通过详细的 RFC 了解一下为什么 Vue 团队做出这个决。..
<!-- more -->
...
一些我们考虑带给 Vue 2.7 的功能： 
 ...
 单文件组件（SFC）中的script setup语法。 `emits` 选项。 
 提升 TypeScript 类型支持。 
```
