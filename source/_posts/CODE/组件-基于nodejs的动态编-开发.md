...
<!-- more -->
 ...
 动态构建 
  ...
  利用 nodejs 我们搭建了一个动态编译 weex 组件的平台，运营人员通过在后台系统的图形界面构建出所要的大促页面，然后点击构建，后台系统就会统一页面所用的组件，在内网通过http请求发送到node编译平台，然后平台根据所需的组件，在线更新组件文件，在线构建WEEX所需的编译环境，编译 JS Bundle文件，异步发送给后台平台。 
 ...
 总结 
  ...
  在这套方案上线之后，已经服务过多次大促，现在线上页面已经达到了10000+，可以支撑大促期间的页面搭建，同时也给用户带来了很好的用户体验，并且极大的提升运的搭建效率。 
