...
鸿蒙（HarmonyOS）最新版的IDE Beta3于2021-03-31发布，beta3增加了很多吸引人的功能，这些功能有一些与编程有关，有一些与配置、模板有关。本文主要深入介绍与编程有关的3个特性：双向预览。..
<!-- more -->
...
![Test](https://dl-harmonyos.51cto.com/images/202104/98f4420079d0302c040077fc73f014571cdc40.jpg  '-鸿蒙学院-鸿蒙IDE迎来重大更新，新特性足以让你尖叫') 在开发阶段，开发者可借助由Java测试框架供的IAbilityDelegator，进行APP组件操控测试（如：启动/关闭FA、获取界面UI元素、注入UI点击事件等），及时发现UI交互问题。或使用JUnit 4语法范式，编写测试用例、调用系统接口，获得API返回值或触发业务流程，根据接口返回值或业务状态，判断业务逻辑的正确性。 
```
