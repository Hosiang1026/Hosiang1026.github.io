...
&emsp;&emsp;分库分表，根据我个人的经验来看，至少需要保证分好之后的小表在业务发展的几年之内都不会出现单表数据量过大（比如达到千万级）。
...
![输入图片说明](/photo/album/image/image_131.png "屏幕截图.png")
...
![输入图片说明](/photo/album/image/image_132.png "屏幕截图.png")

![输入图片说明](/photo/album/image/image_133.png "屏幕截图.png")
