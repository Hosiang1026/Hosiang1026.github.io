...
![Database](https://pic.hosiang.dpdns.org/image/2024/12/15/10t23ou.png "常用的分库分表中间件-基础篇")
...
![常用的分库分表中间件](https://pic.hosiang.dpdns.org/image/2024/12/15/10t27l6.png "常用的分库分表中间件")

上面图中所描述的只是最简单的一种情况（取第一页数据），看起来对性能的影响并不大。但是，如果想取出第10页数据，情况又将变得复杂很多，如下图所示：
![常用的分库分表中间件](https://pic.hosiang.dpdns.org/image/2024/12/15/10t285t.png "常用的分库分表中间件")
