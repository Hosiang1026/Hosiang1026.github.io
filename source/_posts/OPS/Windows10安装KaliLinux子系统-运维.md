...
Windows 10一周年正式版开始支持WSL（Windows的Linux子系统），微软为WSL带来了备受赞誉的Kali Linux。本文详细介绍如何在Windows 10中安装Kali Linux子系统，用原生Kali替换默认的Ubuntu，实现Bash on Kali on Windows
