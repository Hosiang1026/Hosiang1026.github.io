...
![Test](https://oscimg.oschina.net/oscnet/068799f3-7aef-407c-96be-c63856cdf2a7.jpg 'Notion 编辑器原理分析，如此好用的富文本是如何实现的-') 一款如此好的笔记工具，不得不让我了解他的技术原理，接下来讲一讲。
...
```
   但插入 block 还有一个操作，记录是插在哪个 block 的后面。  
