...
文章已经收录在 Github.com/niumoo/JavaNotes ，更有 Java 程序员所需要掌握的核心知识，欢迎Star和指教。 欢迎<!-- more -->
...
```
  ...
  ```  
这次记录下了每台服务器的整体性能，给出一个数值，数值越大，性能越好。可以承受的请求也就越多，可以看到服务器  ```text
  192.168.1.5
  `的性能为 4，是其他服务器的两倍，依旧 10 w 请求测试。```text
...
```
文章有帮助可以点个「赞」或「分享」，都是支持，我都喜欢！ 文章每周持续更新，要实时！[Test](https://oscimg.oschina.net/oscnet/up-58f06104ec2803bd84df21b5d452ed5fd4a.png  '一篇有趣的负载均衡算法实现')
```
