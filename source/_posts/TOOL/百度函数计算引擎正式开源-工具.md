...
  
适用于以下场景： 
私有化部署、边缘计算、物网、CICD、数据和事件处理、多媒体处理、响应式对话、定时任务等场景。 
  
...
  
如在使用中遇到问题，快速沟通，可微扫描二维码，  
![Test](https://oscimg.oschina.net/oscnet/up-089044190ad5c3eea057edc9175b94d908a.png  '百度 Serverless 函数计算引擎 EasyFaaS 正式开源') 
了解更多微服务、云原生技术的相关信息，请![Test](https://oscimg.oschina.net/oscnet/up-089044190ad5c3eea057edc9175b94d908a.png  '百度 Serverless 函数计算引擎 EasyFaaS 正式开源') 
  
  
 
