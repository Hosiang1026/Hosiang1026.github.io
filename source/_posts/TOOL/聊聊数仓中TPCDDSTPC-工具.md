---
title: 聊聊数仓中TPC-DS&TPC-H与查询性能的那些事儿
categories:
  - 工具
  - 数据与存储
tags:
...
受限于编辑器的显示，为了更好地阅读效果，烦请下载附件的原版文档查看，获取相关脚本。 其中涉及的很多操作细节无法一一展开叙述，以梳理和展示整体的逻辑为主。其中主要涉及的工具OBS/GDS/JDBC...
...
其中涉及的很多操作细节无法一一展开叙述，以梳理和展示整体的逻辑为主。其中主要涉及的工具OBS/GDS/JDBC copy后续会单独开叙述。若有无法解决的疑问，欢迎评论留言。
...
-dir 指定生成数据文件存放的目录
可以通过du –sh tpcds100X/*.dat，判断据文件的生成进度。1000Xtpcds数据文件总大小约920GB，
