...
```
根据控制台的输出信息，经过查阅相关资料后找到了原因：该问题由Flutter版本升级导致的重大更改引起的：https://groups.google.com/g/flutter-announce/c/sHAL2fBtJ1Y/m/mGjrKH3dEwAJ 具体解决方法为：在main.dart文件中的main方法中，需要在runApp()前显式调用如下代码： `WidgetsFlutterBinding.ensureInitialized();` #### 总结
```
