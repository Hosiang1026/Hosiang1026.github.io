...
想必大家平时也没那么多时间是单独看源码，又或者只是单纯的看源码遇到问题还是不知道怎么从源码的角度解决。 但是大家平时开发过程中肯定会遇到这样或那样的小问题，通过百度、Google搜索都无果，想尝...
...
3）第18行，通过deltaMs和mPixelsPerMs 算出当前时间差要移动的位移，复制给mScroll。
