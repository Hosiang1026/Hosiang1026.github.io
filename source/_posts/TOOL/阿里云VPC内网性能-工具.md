...
:风起 背景 随着互联网的快速发展，互联网衍生出来的多种工具、服务早已融入我们工作、生活的每个角落，因此互联网服务的稳定性也愈加重要，如网络挂号问诊、网上政务办理、网络消费娱乐。..
<!-- more -->
...
用户可在开通 PTS 服务后，前往购买页面购买内网压测资源包[2]，购买后进入 PTS 控制台，即可查看对应的资源包。 
```
...
#### 1.7 多协议下的 VPC 内网性能测试
除了支持 HTTP 协议的 VPC 内网性能测试外，PTS 还支持其他协议以及对阿里云基础产品的性能测试，如 MQTT、Reids、MQ 等。 
