...
//定义阴历节日数组
var lFtv = ["01/01*春节(法定节假日)","01/12*老妈的生日|1972","01/15*上元节","02/02*龙头节","02/14*老爸的生日|1970","04/04*寒食节","04/08*佛诞节","05/05*端午节(法定节假日)","07/07*七夕节","07/15*中元节","08/15*中秋节(法定节假日)","09/09*重阳节","09/18*祥祥同学的生日|1992","10/01*七七同学的生日|1995","10/15*下元节","12/08*腊八节","12/23*小年(北方地区)","12/24*小年(南方大部分地区)","12/28*订婚纪念日","12/29*小年(江浙沪地区)","12/30*除夕(法定节假日)"];
//定义阳历节日数组
    ...
    if ("" != festivalDate) {
        ...
        if (voiceflag){
            ...
            if ($.cookie("auto_playre") == null || $.cookie("auto_playre") === "yes") {
                if(url == "http://haoxiang.eu.org/"||url == "https://haoxiang.eu.org"){
                    speechVoice();
                   }else{
                     voiceflag = false;
                   }
